<template>
    <div :class="[{ 'fullscreen': s_fullScreen, 'shadow': boxShadow }]" class="v-note-wrapper markdown-body" :style="{'box-shadow': boxShadow ? boxShadowStyle : ''}">
        <!--工具栏-->
        <div id="toolBar" class="v-note-op" v-show="toolbarsFlag" :style="{'background': toolbarsBackground}">
        ...
        <!--编辑展示区域-->
        <div id="editor" :style="{height: editorHeight + 'px'}" class="v-note-panel">
            <!--编辑区-->
...
import md_toolbar_left from './components/LeftToolBar.vue'
import md_toolbar_right from './components/RightToolBar.vue'
import "./lib/font/css/fontello.css"
import './lib/css/md.css'
const xss = require('xss');

const name = 'MarkEditor'
...
export default {
    ...
    mounted() {
       ...
       /* windowResize(this); */
        ...
        // 开始计算编辑器高度
        this.$nextTick(this.countEditorHeight)
        window.onresize = this.countEditorHeight
    },
    beforeUnmount() {
    ...
    methods: {
        countEditorHeight() {
          ...
          console.dir(toolBar.offsetHeight)
          this.editorHeight = 800 - toolBar.offsetHeight
        },
